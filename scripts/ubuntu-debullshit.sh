...
setup_vanilla_gnome() {
    ...
    apt install gnome-session fonts-cantarell adwaita-icon-theme-full gnome-backgrounds vanilla-gnome-default-settings -y && apt remove ubuntu-session yaru-theme-gnome-shell yaru-theme-gtk yaru-theme-icon yaru-theme-sound -y
    set_fonts
}
